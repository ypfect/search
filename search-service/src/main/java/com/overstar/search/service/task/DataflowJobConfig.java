...
package com.overstar.search.service.task;
...
import com.overstar.search.service.template.job.dataflow.SpringDataflowJob;
...
@Configuration
@ConditionalOnProperty(value = "dataflow-job.enable",havingValue = "true")
